            ...
            <div className="flex flex-row">
              ...
              <div className="w-full">
                ...
                <div className=" grid grid-cols-4 px-8 gap-5">
                  <Card className="bg-primary !important text-white" title="Total Revenue" icons={<TbCurrencyNaira className="size-10 text-white bg-light p-2 rounded-full"/>} info="10M"/>
